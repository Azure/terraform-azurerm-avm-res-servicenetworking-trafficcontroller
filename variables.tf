...
A map of diagnostic settings to create on the Application Gateway for Containers resource. The map key is deliberately arbitrary to avoid issues where map keys maybe unknown at plan time.
